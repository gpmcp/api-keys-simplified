...
///
/// The generate and verify layers consume this by shared reference; it carries
/// no secret material and is cheap to clone.
#[derive(Debug, Clone, PartialEq, Eq)]
...
impl ConfigBuilder {
    ...
    /// larger checksum, stronger Argon2 params).
