...
## [0.2.2](https://github.com/gpmcp/api-keys-simplified/compare/v0.2.1...v0.2.2) - 2025-12-13

### Other

- *(validator)* remove hardcoded dummy key for timing protection ([#18](https://github.com/gpmcp/api-keys-simplified/pull/18))
